...
-- enforcing the constraint using SQL would be costly. For all parts of the A2 warmup,
...
DROP SCHEMA IF EXISTS VetWarmup CASCADE;
CREATE SCHEMA VetWarmup;
...
-- You may assume:
-- 	* A procedure <pr_id> that involves a restricted supply, must
--    involve a vet.
